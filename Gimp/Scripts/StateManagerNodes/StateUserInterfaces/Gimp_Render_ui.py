...
class Ui_wg_Gimp_Render(object):
    def setupUi(self, wg_Gimp_Render):
        ...
        self.w_name = QWidget(wg_Gimp_Render)
        ...
        self.gb_export = QGroupBox(wg_Gimp_Render)
        ...
        self.chb_jpg_optimize.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        ...
        self.chb_jpg_progressive.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        ...
        self.chb_jpg_baseline.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        ...
        self.l_png_compress.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        ...
        self.l_tiff_compress.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        ...
        self.l_tiff_useBig.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.l_tiff_alphaColor.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        self.l_tiff_alphaColor.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.chb_tiff_useBig.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        ...
        self.chb_tiff_alphaColor.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        ...
        self.chb_pdf_omitHidden.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        ...
        self.chb_pdf_applyLayers.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        ...
        self.gb_psdOptions.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        ...
        QMetaObject.connectSlotsByName(wg_Gimp_Render)
    # setupUi

    def retranslateUi(self, wg_Gimp_Render):
        wg_Gimp_Render.setWindowTitle(QCoreApplication.translate("wg_Gimp_Render", u"Export", None))
        self.l_name.setText(QCoreApplication.translate("wg_Gimp_Render", u"Name:", None))
        self.l_class.setText(QCoreApplication.translate("wg_Gimp_Render", u"Render", None))
        self.gb_export.setTitle(QCoreApplication.translate("wg_Gimp_Render", u"General", None))
        self.label_4.setText(QCoreApplication.translate("wg_Gimp_Render", u"Context:", None))
        self.l_context.setText("")
        self.b_context.setText(QCoreApplication.translate("wg_Gimp_Render", u"Select", None))
        self.l_tasklabel.setText(QCoreApplication.translate("wg_Gimp_Render", u"Identifier:", None))
        self.l_taskName.setText("")
        self.b_changeTask.setText(QCoreApplication.translate("wg_Gimp_Render", u"change", None))
        self.l_master.setText(QCoreApplication.translate("wg_Gimp_Render", u"Master Version:", None))
        self.l_outPath.setText(QCoreApplication.translate("wg_Gimp_Render", u"Location:", None))
        self.l_imageSpecs.setText(QCoreApplication.translate("wg_Gimp_Render", u"Image Info:", None))
        self.l_spec_rezLabel.setText(QCoreApplication.translate("wg_Gimp_Render", u"Resolution:", None))
        self.l_specs_Xrez.setText(QCoreApplication.translate("wg_Gimp_Render", u"XXXX", None))
        self.l_specs_rezXtext.setText(QCoreApplication.translate("wg_Gimp_Render", u"  x  ", None))
        self.l_specs_Yrez.setText(QCoreApplication.translate("wg_Gimp_Render", u"XXXX", None))
        self.l_specs_ColorMode_text.setText(QCoreApplication.translate("wg_Gimp_Render", u"Color Mode:", None))
        self.l_specs_ColorMode.setText(QCoreApplication.translate("wg_Gimp_Render", u"XXXX", None))
        self.l_specs_BitDepth_text.setText(QCoreApplication.translate("wg_Gimp_Render", u"Bit Depth", None))
        self.l_specs_BitDepth.setText(QCoreApplication.translate("wg_Gimp_Render", u"XXXX", None))
        self.l_specs_Gamma_text.setText(QCoreApplication.translate("wg_Gimp_Render", u"Gamma:", None))
        ...
        self.chb_png_gamma.setText(QCoreApplication.translate("wg_Gimp_Render", u"Save Gamma     ", None))
        self.chb_png_interlaced.setText(QCoreApplication.translate("wg_Gimp_Render", u"Interlaced          ", None))
        ...
        self.chb_pdf_applyLayers.setText(QCoreApplication.translate("wg_Gimp_Render", u"Apply layers masks", None))
        self.chb_pdf_convertToVector.setText(QCoreApplication.translate("wg_Gimp_Render", u"Bitmaps to Vector", None))
        self.chb_psd_saveAsScene.setText(QCoreApplication.translate("wg_Gimp_Render", u"Save .psd as Scenefile        ", None))
        self.gb_previous.setTitle(QCoreApplication.translate("wg_Gimp_Render", u"Last export", None))
